...
/**
 * 应用程序配置类：用于保存用户相关信息及设置 .样式如下
 * #Sat Dec 28 06:46:09 EST 2013 user.fans=0
 * save_image_path=/storage/sdcard/OSChina/
 * user.pwd=858FEE408A2CF728D2FF27428133AD7D user.location=\u6c5f\u897f
 * \u5357\u660c cookie=oscid\=PR7FwfDo%2F%2
 * BLgKYItYNcGB4iXdL2F8MQgfSf7kVY4H3xQVpuay59OfmoGsblVWtI
 * %2B6y0a3%2FV%2B%2BFh6aBjkE1dQGkh0irq%2FcIvDA0qDhmhLoTHR0Go5EKPiCg%3D%3D;
 * APP_UNIQUEID=54ecc87b-14e1-41fa-83e8-94c3a7d36d55 user.name=yangwendaxia
 * user.followers=0 user.account=yangwendaxia@foxmail.com user.isRememberMe=true
 * user.uid=248884 user.score=0 user.face=
 * 
 * 
...
public class AppConfig
{
	...
	{
		Properties props = get();// {save_image_path=/mnt/sdcard/OSChina/,
									// user.score=0, user.name=yangwendaxia,
									// temp_post_catalog=1,
									// user.account=yangwendaxia@foxmail.com,
									// user.uid=248884, user.followers=0,
									// user.face=, user.location=江西 南昌,
									// APP_UNIQUEID=82258296-9899-452c-bbdc-43482e257284,
									// user.isRememberMe=true, user.fans=0,
									// user.pwd=858FEE408A2CF728D2FF27428133AD7D}
		for (String k : key)
			props.remove(k);
		setProps(props);
	}
