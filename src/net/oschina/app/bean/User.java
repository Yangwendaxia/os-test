...
public class User extends Base
{
	...
	{
		//<?xml version="1.0" encoding="UTF-8"?><oschina>  <result>    <errorCode>1</errorCode>    <errorMessage><![CDATA[登录成功]]></errorMessage>  </result>    <user>    <uid>248884</uid>    <location><![CDATA[江西 南昌]]></location>    <name><![CDATA[yangwendaxia]]></name>    <followers>0</followers>    <fans>0</fans>    <score>0</score>    <portrait></portrait>  </user>  <notice><atmeCount>0</atmeCount><msgCount>0</msgCount><reviewCount>0</reviewCount><newFansCount>0</newFansCount></notice></oschina><!-- Generated by OsChina.NET (init:2[ms],page:1[ms],ip:118.212.199.60) -->
		User user = new User();
		Result res = null;
		// 获得XmlPullParser解析器
			...
			while (evtType != XmlPullParser.END_DOCUMENT)
			{
				...
				switch (evtType)
				{
					case XmlPullParser.START_TAG:
						...
						else if (res != null && res.OK()) //处理结果信息正确时情况
						{
							if (tag.equalsIgnoreCase("uid"))//这里说明uid有以下用户信息是由服务器返回的
							{
